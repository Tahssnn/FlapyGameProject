...
begin
image3.Position.X:= 150 ;
image4.Position.X:= 150 ;
image5.Position.X:= 350 ;
image6.Position.X:= 350 ;
image7.Position.X:= 550 ;
image8.Position.X:= 550 ;

image3.Position.Y:= -100 ;
image4.Position.Y:= 300 ;
image5.Position.Y:= 0 ;
image6.Position.Y:= 400 ;
image7.Position.Y:= -200 ;
image8.Position.Y:= 200 ;

image2.Position.X:= 25;
image2.Position.Y:= 150;
